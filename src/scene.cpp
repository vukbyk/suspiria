...
void Scene::prepareAssetsManyCubes()
{
    ...
    e=CreateEntity().addTexturePBRComp("rustediron/albedo.png",/*"normal1x1.png"*/ "rustediron/normal.png", "rustediron/metallic.png", "rustediron/roughness.png", "rustediron/ao.png")
            .addMeshComponent("cubemaya.obj")
            .addTransformComponent( 3.0, 10.0f, -7.0f)
            .addDynamicShadowComp();
}
